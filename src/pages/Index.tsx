...
import { ChevronDown, Music, Mic, Target, PartyPopper, Star } from "lucide-react";
...
const experienceBlocks = [
  { title: "Oasis Patio Bar", desc: "The largest and most beautiful bar on the lake.", img: patio },
  { title: "Patriot Bar", desc: "Honoring our service men and women.", img: bar },
  { title: "Craft Cocktails", desc: "Our mixologists don't pour drinks. They create moments.", img: cocktails },
];

const eventCards = [
  { title: "Live Music", sub: "Friday & Saturday", img: eventsMusic, icon: Music },
  { title: "Themed Night Karaoke", sub: "Thursday", img: karaoke, icon: Mic },
  { title: "Golf Simulator Room", sub: "Private bookings available", img: golfSim, icon: Target },
  { title: "Private Events", sub: "Parties & Celebrations", img: privateEvents, icon: PartyPopper },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {eventCards.map((card, i) => (
              <FadeIn key={card.title} delay={i * 0.1}>
                <div className="group relative rounded-xl overflow-hidden aspect-[16/10] cursor-pointer">
                  <img
                    src={card.img}
                    alt={card.title}
